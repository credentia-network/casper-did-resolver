...
If you have questions about how to set up your account to use casper-did-resolver, and how it would be seen on [CSPR.Live](https://cspr.live), please direct these to the related discord channels:
...
for the casper-did-resolver project. This is a well established and widely used
mechanism to assure contributors have confirmed their right to license
their contribution under the project's license.
Please read [developer-certificate-of-origin](https://github.com/make-software/casper-did-resolver/blob/master/.github/developer-certificate-of-origin).

...
class CasperDidResolver extends did_resolver_1.Resolver {
    ...
    resolve(didUrl, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const didDocument = yield this.readDidDocument(didUrl, clientRpc, stateRootHash);
            yield this.readDelegates(didDocument, didUrl, clientRpc, stateRootHash);
            yield this.readAttributes(didDocument, didUrl, clientRpc, stateRootHash);
            return {
    ...
    readKey(key, clientRpc, stateRootHash) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield clientRpc.getBlockState(stateRootHash, CONTRACT_DID_HASH, [key]);
            return (_a = result === null || result === void 0 ? void 0 : result.CLValue) === null || _a === void 0 ? void 0 : _a.data;
        });
    }
    readDidDocument(didUrl, clientRpc, stateRootHash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const key = this.buildKey(didUrl);
                return yield this.readKey(key, clientRpc, stateRootHash);
            }
            catch (e) {
    ...
    readDelegates(didDocument, didUrl, clientRpc, stateRootHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const deletagesLength = yield this.readDeligateLength(didUrl, clientRpc, stateRootHash);
            if (deletagesLength) {
                const arr = new Array(deletagesLength).fill(0).map((_, i) => i);
                const nowTimestamp = new Date().valueOf();
                for (const index of arr) {
                    const key = this.buildKey(didUrl, `_delegate_${index}`);
                    const result = yield this.readKey(key, clientRpc, stateRootHash);
    ...
    readDeligateLength(didUrl, clientRpc, stateRootHash) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    readAttributes(didDocument, didUrl, clientRpc, stateRootHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const attributesLength = yield this.readAttributesLength(didUrl, clientRpc, stateRootHash);
            if (attributesLength) {
    ...
    readAttributesLength(didUrl, clientRpc, stateRootHash) {
        return __awaiter(this, void 0, void 0, function* () {
